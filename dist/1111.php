    ...
    <body class="app-ui layout-has-drawer layout-has-fixed-header">
                                    ...
                                    <tbody>
                                        ...
                                        if ($result->num_rows > 0) {
                                            ...
                                            while($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<td>
                                                <button type='button' class='btn btn-primary editbtn' id='employee_edit_btns' data-edit_id='".$row['employee_id']."'><i class='fa fa-pencil'></i></button>
        ...
        <script>
            $(document).ready(function(){
                ...
                $("#employee_tbl").on("click",".editbtn", function(e){
                    e.preventDefault();
